...
export const metadata: Metadata = {
  ...
  description: "SpaceX designs, manufactures and launches advanced rockets and spacecraft. Join us in making life multiplanetary.",
  keywords: "SpaceX, rocket, spacecraft, Mars, space exploration, satellite, Falcon 9, Dragon, Starlink",
  metadataBase: new URL("https://www.spacex.com"),
  alternates: {
    canonical: "https://www.spacex.com"
  },
  openGraph: {
    title: "SpaceX - Making Life Multiplanetary",
    description: "Leading the future of space exploration with reusable rockets and advanced spacecraft technology.",
    siteName: "SpaceX",
    images: [{
      url: "https://images.pexels.com/photos/60130/pexels-photo-60130.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "SpaceX - Making Life Multiplanetary",
    description: "Leading the future of space exploration with reusable rockets and advanced spacecraft technology.",
    images: ["https://images.pexels.com/photos/60130/pexels-photo-60130.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
